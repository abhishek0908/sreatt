  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://sreatt-backend.vercel.app/api/warranty/register-warranty",
        {
          method: "POST",
          headers: {
      ...
      setSuccessMessage(data.message || "Warranty registered successfully!");
      setFormData({
        dealerName: "",
        address: "",
        customerName: "",
      ...
      // Scroll to the message area after submission
    ...
    <div className="flex flex-col justify-center items-center min-h-screen bg-gradient-to-b from-gray-600 via-gray-500 to-gray-300 text-white font-sans">
      <div className="text-center p-8 space-y-8 max-w-3xl mx-auto w-full">
        ...
        <form
          ...
          className="bg-white p-6 rounded-lg shadow-lg text-gray-800 space-y-6 w-full max-w-md mx-auto"
        >
          {/* Dealer Name */}
          <div>
        ...
        {/* Messages */}
        <div ref={messageRef} className="space-y-4 mt-6">
          {successMessage && (
